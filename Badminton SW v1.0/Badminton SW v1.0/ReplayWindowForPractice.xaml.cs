...
{
    /// <summary>
    /// Interaction logic for ReplayWindowForPractice.xaml
    /// </summary>
    public partial class ReplayWindowForPractice : Window
    {
        ...
        private Pen trackedBonePen = new Pen(Brushes.Orange, 8);
        private Pen inferredBonePen = new Pen(Brushes.Orange, 1);
        ...
        private List<Brush> myBrushList;
        ...
        private string filePath1 = "Recordings/XrightHand.txt";
        private string filePath2 = "Recordings/XrightShoulderCenterCount.txt";
        private string filePath3 = "Recordings/XleftHand.txt";
        private string filePath4 = "Recordings/XleftShoulderCenter.txt";
        private string filePath5 = "Recordings/XheadSpine.txt";
        private string filePath6 = "Recordings/XTrightLeg.txt";
        private string filePath7 = "Recordings/XrightHip.txt";
        private string filePath8 = "Recordings/XbetweenHips.txt";
        private string filePath9 = "Recordings/XleftLeg.txt";
        private string filePath10 = "Recordings/XleftHip.txt";
        private string filePath11 = "Recordings/XleftSpineThigh.txt";
        private string filePath12 = "Recordings/XrightSpineThing.txt";
        private string filePath13 = "Recordings/XrightShoulderSpine.txt";
        private string filePath14 = "Recordings/XleftShoulderSpine.txt";
        private string filePath15 = "Recordings/XrightHandFingers.txt";
        private string filePath16 = "Recordings/XrightWristSpine.txt";
        private string filePath17 = "Recordings/XleftWristSpine.txt";
        private string filePath18 = "Recordings/XleftHandFingers.txt";
        ...
        public ReplayWindowForPractice(List<Skeleton> listOfTraineeSkeletons, List<Brush> listOfBrushes)
        {
            InitializeComponent();
            this.Show();
            mySkeleton = new Skeleton();
            mySkeletonList = new List<Skeleton>();
            mySkeletonList = listOfTraineeSkeletons;
            numberOfFrames = listOfTraineeSkeletons.Count;
            myBrushList = listOfBrushes;
        }
            ...
            try
            {
                ...
                else
                {
                    if (currentFrame < numberOfFrames)
                    {
                        ...
                        trackedBonePen = new Pen(myBrushList[currentFrame], 8);
                        inferredBonePen = new Pen(myBrushList[currentFrame], 1);
                        skeletonCount++;
                        currentFrame++;
